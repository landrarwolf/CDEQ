...
from cm_plugin.refiner import maybe_refine
...
class IGNN_solver(nn.Module):
    ...
    def forward(self, U, A, **kwargs):
        ...
        cm_refiner = kwargs.get('cm_refiner', None)
        ...
        new_z_star = maybe_refine(new_z_star, cm_refiner, context={"A": A, "U": U})
...
class IGNN_solver_plus(nn.Module):
    ...
    def forward(self, U, A, **kwargs):
        ...
        if simple:
            ...
            z_star_hyp = maybe_refine(z_star_hyp, cm_refiner, context={"A": A, "U": U})
